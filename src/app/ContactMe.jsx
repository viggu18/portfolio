  ...
  return (
    <div className="w-full" id="getintouch">
      ...
      <div className="flex flex-col justify-center items-center w-full">
        <p className="xl:text-xl lg:text-xl md:text-xl font-bold sm:text-md">
          I'd love to hear from you
        </p>
        <p className="font-medium xl:text-sm lg:text-sm md:text-sm sm:text-xs xs:text-xs text-gray-500 xl:w-[400px] lg:w-[400px] md:w-[400px] sm:w-[80%] xs:w-[80%] text-center">
